...
{
    public class TransactionResultBO:BOBase
    {
        TransactionResultDAO transactionResultsDAO = new TransactionResultDAO();
        ...
        public int UpdateTransactionResults()
        {
            return transactionResultsDAO.UpdateTransactionResults(this);
        }
        #endregion
    }
}
